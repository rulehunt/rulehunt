...
- [Checkout resolution — link, not a second clone (AC1)](#checkout-resolution--link-not-a-second-clone-ac1)
- [The name collision with `./.loom/bin/loom`, and how it is resolved (AC3)](#the-name-collision-with-loombinloom-and-how-it-is-resolved-ac3)
- [`status` output across contexts (AC7)](#status-output-across-contexts-ac7)
...
- [Uninstall semantics](#uninstall-semantics)
<!-- toc:end -->
