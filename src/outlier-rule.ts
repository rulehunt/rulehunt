...
const BASE_PATTERNS: number[] = [
  7, 11, 13, 14, 19, 21, 22, 23, 25, 26, 27, 28, 29, 30,
  33, 35, 37, 39, 42, 43, 44, 45, 46, 47, 49, 50, 51, 53,
  54, 55, 57, 58, 59, 60, 61, 62, 63, 69, 70, 71, 73, 74,
  75, 77, 78, 79, 81, 83, 84, 85, 86, 87, 91, 93, 95, 97,
  99,
];
