...
<!-- GENERATED FILE — DO NOT EDIT DIRECTLY.
     ...
     defaults/.claude/commands/loom/hermit.md (the same source Claude Code
     reads as /loom:hermit via .claude/commands/loom/). This is the
...
- [Your Role](#your-role)
- [IMPORTANT: Label Gate Policy](#important-label-gate-policy)
- [What You Look For](#what-you-look-for)
- [How to Analyze](#how-to-analyze)
- [Random File Review](#random-file-review)
- [Goal-Aligned Simplification Priority](#goal-aligned-simplification-priority)
- [Creating Removal Proposals](#creating-removal-proposals)
