---
name: loom-builder-complexity
description: "This document covers complexity assessment, issue decomposition, and scope management for the Builder role. For the core builder workflow, see `builder.md`."
---
<!-- loom-managed-skill -->
<!-- GENERATED FILE — DO NOT EDIT DIRECTLY.
     Produced by `loom-daemon generate-agent-skills` from
     defaults/.claude/commands/loom/builder-complexity.md (the same source Claude Code
     reads as /loom:builder-complexity via .claude/commands/loom/). This is the
...
- [Never Abandon Work](#never-abandon-work)
- [Auditing Before Decomposition](#auditing-before-decomposition)
- [Assessing Complexity Before Claiming](#assessing-complexity-before-claiming)
