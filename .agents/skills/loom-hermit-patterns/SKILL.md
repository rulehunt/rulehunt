---
name: loom-hermit-patterns
description: "This file contains detailed patterns, examples, and reference scripts for the Hermit role. It is meant to be consulted when needed, not loaded as primary instructions."
---
<!-- loom-managed-skill -->
<!-- GENERATED FILE — DO NOT EDIT DIRECTLY.
     Produced by `loom-daemon generate-agent-skills` from
     defaults/.claude/commands/loom/hermit-patterns.md (the same source Claude Code
     reads as /loom:hermit-patterns via .claude/commands/loom/). This is the
...
- [Detailed Code Smell Examples](#detailed-code-smell-examples)
- [Analysis Scripts](#analysis-scripts)
- [Random File Review - Detailed Workflow](#random-file-review---detailed-workflow)
- [Goal Discovery Scripts](#goal-discovery-scripts)
- [Creating Removal Proposals - Full Templates](#creating-removal-proposals---full-templates)
