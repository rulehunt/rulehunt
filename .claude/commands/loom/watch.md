...
hand — a hard-won reference night's incidents and naming rationale are encoded
below; background: [`.loom/docs/watch-design-notes.md`](../../../.loom/docs/watch-design-notes.md).
...
- [Arguments](#arguments)
- [Tick 0: preflight](#tick-0-preflight)
- [Health probe (`loom-daemon health`)](#health-probe-loom-daemon-health)
- [The tick](#the-tick)
- [Remediation playbook](#remediation-playbook)
- [Escalation contract](#escalation-contract)
- [Loop mechanics](#loop-mechanics)
- [Dry-run mode](#dry-run-mode)
- [End-of-window summary](#end-of-window-summary)
- [See also (cross-links, not duplicated here)](#see-also-cross-links-not-duplicated-here)
...
- [`.loom/docs/watch-design-notes.md`](../../../.loom/docs/watch-design-notes.md) —
  the reference night this skill was built from, and why it's named `watch`.
