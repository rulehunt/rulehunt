...
- [Issue Creation Command](#issue-creation-command)
- [Autonomous Mode Assumptions Template](#autonomous-mode-assumptions-template)
- [Requirements Gathering Examples](#requirements-gathering-examples)
- [Epic Proposals](#epic-proposals)
- [Tracking Dependencies with Task Lists](#tracking-dependencies-with-task-lists)
- [Goal Discovery Script](#goal-discovery-script)
- [Backlog Balance Check Script](#backlog-balance-check-script)
- [Milestone Alignment Examples](#milestone-alignment-examples)
<!-- toc:end -->
